...
(function($) {
    if ($.ui) {
        $.prompt = function(message, options) {
            ...
            $("<p id='promptMessage'>" + message + "</p>").appendTo('#promptDialog');
//            $('<hr />').appendTo('#promptMessage');
            var input = $("<input id='result' type='textbox' style='width:100%' value='" + defaultOptions.defaultResult + "' />").appendTo('#promptMessage');
            input.keypress(function(e) {
                if (e.keyCode == $.ui.keyCode.ENTER) {
                	defaultOptions.buttons.Ok.call($("#promptDialog"));
                }
            });
        ...
        $.confirm = function(message, options) {
            ...
            $("<p id='confirmMessage'>" + message + "</p>").appendTo('#confirmDialog');
